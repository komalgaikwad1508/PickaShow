...
urlpatterns = [
    ...
    #path('', views.SnacksView.as_view(), name="home"),

   # path('movie-detail/', views.movie_detail, name='movie-detail'),
    path('add-to-cart/', views.add_to_cart, name='add-to-cart'),
    path('book/',views.show_cart, name='showcart'),
    path('plusbook/',views.plus_book),
    path('minusbook/',views.minus_book),
    ...
    path('movie/<slug:data>', views.movie, name='moviedata'),
